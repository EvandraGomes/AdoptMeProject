...
class SigninController {
    ...
    private fun formatDate(inputDate: String): String? {
        val inputFormat = SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()) // formato dos americanos
        return try {
    ...
    fun registerUser(
        ...
        // ver se todos os campos obrigatórios estão presentes
        ...
        // ver se a data está no formato correto
